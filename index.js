...
// Для массива [1, 2, 3, 4] и числа 5:
//
// Начинаем с 1:
//
// 1 → 2 → сумма 3 → продолжаем
//
// 1 → 2 → 3 → сумма 6 > 5 → возврат
//
// 1 → 3 → сумма 4 → продолжаем
//
// 1 → 3 → 4 → сумма 8 > 5 → возврат
//
// 1 → 4 → сумма 5 → добавляем [1,4] в результат
//
// Переходим к 2:
//
// 2 → 3 → сумма 5 → добавляем [2,3] в результат
//
// 2 → 4 → сумма 6 > 5 → возврат
//
// Переходим к 3:
//
// 3 → 4 → сумма 7 > 5 → возврат
//
// Число 4 само по себе меньше 5, но следующих чисел нет
//
// Итоговый результат: [[1,4], [2,3]]
